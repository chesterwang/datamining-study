...
object DecisionTreeClassificationExample {
  def main(args: Array[String]): Unit = {
    ...
    data.printSchema()
    data.show(10)
    data.select("label").map(_.get(0)).countByValue().foreach(println)
    ...
    // Convert indexed labels back to original labels.tongpeng:原标签
    ...
    println(labelIndexer.explainParams())
